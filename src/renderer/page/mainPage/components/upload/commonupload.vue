			...
			<div>
				...
				<div class="mt10">
					<a-form :form="form" autocomplete="off" class="flex flex-align-top">
						<a-row :gutter="25" class="mb10 flex-1">
							<a-col :span="8">
								<a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="题目总数">
									<a-input-number v-decorator="['totalnum', { rules: [{ required: true, message: '请输入题目总数' }] }]" :min="1" :precision="0" class="w100" />
								</a-form-item>
							</a-col>
							<a-col :span="8">
...
.bg > .upload-bd {
	...
	box-shadow: 0 0 10px rgba($color: #2459a0, $alpha: 0.3);
