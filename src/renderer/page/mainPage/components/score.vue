			...
			<div>
				<a-form :form="form">
					...
					<a-form-item label="评分描述" :label-col="{ span: 4}" :wrapper-col="{ span: 20 }">
						<a-textarea class="textarea" placeholder="请输入评分描述" :rows="4" v-decorator="['describe', { rules: [{ required: true, whitespace: true,message: '请输入评分描述!' },{max:100, message: '描述字数不能超过100!'}] }]" />
					</a-form-item>
				</a-form>
